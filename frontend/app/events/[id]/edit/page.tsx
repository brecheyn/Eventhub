  ...
  const loadEvent = async () => {
    try {
      ...
      if (user?.role !== 'admin' && event.organizerId !== user?.id) {
        toast.error('Vous n\'avez pas les permissions pour modifier cet événement');
        router.push('/events');
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-secondary-50/50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <Link href={`/events/${eventId}`} className="inline-flex items-center text-secondary-600 hover:text-primary-600 mb-4">
