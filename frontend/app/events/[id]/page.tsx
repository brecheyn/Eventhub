...
import { Calendar, MapPin, Users, DollarSign, Edit, Trash2, ArrowLeft, Clock, CheckCircle, XCircle, Lock, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-secondary-600">
                      {event.isFree ? (
                        ...
                        <span className="text-primary-600 font-semibold">{event.ticketPrice} €</span>
                      )}
                    </div>
                  </div>
                </div>
            ...
            {/* Sessions */}
            <SessionsList eventId={eventId} canEdit={userCanEdit && !completed} />
          </div>
            ...
            <div className="card">
              ...
              {completed ? (
                <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-4 text-center text-orange-700">
                  ...
                  <div className="text-sm mt-1">Les inscriptions sont fermées</div>
                </div>
              ) : hasTicket ? (
